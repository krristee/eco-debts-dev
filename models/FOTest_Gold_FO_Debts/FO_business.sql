...
LEFT JOIN {{ref ('FO_map_business_name') }}        as map_business_name        on EQUAL_NULL(bc."Business code", map_business_name."Business code")
LEFT JOIN {{ref ('FO_map_sub_business_code') }}    as map_sub_business_code    on EQUAL_NULL(bc."Project code", map_sub_business_code."Project code")
LEFT JOIN {{ref ('FO_map_sub_business_name') }}    as map_sub_business_name    on EQUAL_NULL(map_sub_business_code."Sub business code", map_sub_business_name."Sub business code")
)
